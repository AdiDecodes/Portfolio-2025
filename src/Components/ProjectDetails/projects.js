...
export default [
	...
	},
	{
		...
		myInvolvement:
			'To implement the real-time speech translation and captions feature, I used WebRTC for real-time communication, and trained a ML model to correctly recognize sentences and translates it. To oversee the development process and ensure the integration of all components, I worked closely with the team to deliver a fully functional website.',
		techStack: [
			'Javascript',
			'React',
			'Vite',
