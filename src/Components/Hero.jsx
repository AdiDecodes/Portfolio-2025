...
import styles from "./Styles/HeroNew.module.scss";
import gsap from "gsap";
import { useGSAP } from "@gsap/react";
import SplitType from "split-type";
import aditya from "../assets/profile.jpeg";
  ...
  return (
    <div className={styles.main}>
      <div className={styles.left} ref={leftref}>
        <h2 id="text1">ADITYA</h2>
        <h2 id="text2">SINGH</h2>
        <p id="text3">
          Hii, I am a Full Stack developer based in 📍 Mumbai, India.
        </p>
        {/* <div className={styles.resumeButton}>
					Resume
				</div> */}
        <div className={styles.scrollBelowContainer} id="scroll">
          <p
            className={styles.scrollDownBox}
            onClick={() =>
              window.scrollTo({
